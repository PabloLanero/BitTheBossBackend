...
namespace BTB.Data
{
    public class BTBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Usuario
            modelBuilder.Entity<Usuario>().Property(s => s.TierId)
                .HasDefaultValue(1);
            modelBuilder.Entity<Usuario>().HasData(
                new Usuario {UsuarioId= 1, Nombre="Ejemplo", Correo="Jhon@gmail.com", Password="asd", FechaCreacion= DateTime.Now, Visible= true, TierId=1 },
                new Usuario {UsuarioId= 2, Nombre="Ejemplo2", Correo="Mary@gmail.com", Password="asdasd", FechaCreacion= DateTime.Now, Visible= true , TierId= 1}
            );
